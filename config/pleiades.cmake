...
set(SZIP_LIB            "")
set(PNETCDF_INCLUDE_DIR "/home1/danew/local/include")
set(PNETCDF_LIB         "/home1/danew/local/lib/libpnetcdf.a")
set(LIBS ${NETCDF_LIB_1} ${NETCDF_LIB_2} ${HDF5_LIB_1} ${HDF5_LIB_2} ${SZIP_LIB} ${PNETCDF_LIB} m z curl)
